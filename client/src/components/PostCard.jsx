...
const PostCard = ({ article }) => {
    ...
    const plainTextContent = stripHtml(article.content); // Strip HTML tags
    ...
    return (
        <div className="max-w-sm group relative bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <img
                src={article.image}
                alt={article.title}
                className="w-[400px] h-48 object-cover group-hover:scale-110 transition-all duration-200"
            />
            <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mb-4">
                    {truncateText(plainTextContent, 20)} {/* Limit to 20 words */}
                </p>
